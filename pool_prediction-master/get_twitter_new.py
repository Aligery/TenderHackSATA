...
parser.add_argument("outputfile", nargs='?', default="tweets_count.json")
parser.add_argument("errorfile", nargs='?', default="tweets_count_error.txt")
